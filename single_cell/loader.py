...
class BioDataset(InMemoryDataset):
    def __init__(self,
                 ...
                 pre_transform=None,
                 pre_filter=None):
        self.edgelist = np.loadtxt('/ram/USERS/ziquanw/COMP683/project/data/DREAM_challenge/1_networks/anonymized/subchallenge1/2_ppi_anonym_v2.txt/2_ppi_anonym_v2.txt')
        self.G = nx.from_edgelist(self.edgelist)
        self.nodes = list(self.G.nodes())
        self.transform = transform
    
    def get(self, index):
        # pyg_data = 
        return nx_to_graph_data_obj(G, index)
