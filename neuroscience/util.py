...
# from torch_geometric.utils import to_networkx as graph_data_obj_to_nx_simple
# from torch_geometric.utils import from_networkx as nx_to_graph_data_obj_simple
...
def nx_to_graph_data_obj_simple(G):
    ...
    for _, node in G.nodes(data=True):
        node_attr = node['node_attr']
        node_attr_list.append(node_attr)
    x = torch.tensor(np.array(node_attr_list), dtype=torch.long)
