...
def main():
    ...
    parser.add_argument('--model_file', type=str, default = 'neuroscience/model_weights/graphview%s_contextpred.pth', help='filename to output the model')
    parser.add_argument('--num_workers', type=int, default = 4, help='number of workers for dataset loading')
    parser.add_argument('--csize', type=int, default=3,
                        help='context size (default: 3).')
    parser.add_argument('--graph_view', type=str, default = 'FC')
    ...
    #set up dataset
    dataset = HCPAScFcDatasetOnDisk('AAL_116', node_attr=args.graph_view, transform = ExtractSubstructureContextPair(args.num_layer, l1, l2))
    print(dataset[0])
